...
TRAIN_FLAGS="--lr 3e-5 --batch_size 8 --lr_anneal_steps=300000 --log_interval 10000 --save_interval 10000 "
DIR_TRAIN="--data_dir /lustre/ssd/ws/dchristi-diffusion2/dataset/fiber-data_256x256 --dir /lustre/ssd/ws/dchristi-diffusion2/checkpoints/fiber_1x256x256_test_w_descriptor_checkpoint"


python scripts/image_train.py $DIR_TRAIN $MODEL_FLAGS $CHECK_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS --resume_checkpoint /lustre/ssd/ws/dchristi-diffusion2/checkpoints/fiber_1x256x256_test_w_descriptor/model154000.pt
