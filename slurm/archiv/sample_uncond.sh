...
DIR_TRAIN="--data_dir datasets/combined_deav_fiber_256 --dir checkpoints/combined_deav_fiber_256"

## specify model checkpoint folder
MODELDIR="/lustre/ssd/ws/dchristi-diffusion/diff_recon/checkpoints/combined_deav_fiber_256" 
# MODELLIST="
# model000000.pt 
# model010000.pt 
# model020000.pt 
...
for MODEL in ${MODELLIST};do echo ${MODELDIR}/${MODEL};
    ...
    SAMPLE="--model_path ${MODELDIR}/${MODEL} --dir /lustre/ssd/ws/dchristi-diffusion/samples/combined/${MODEL}"; 
    echo ${SAMPLE};
    python scripts/image_sample_uncond_th.py $SAMPLE $MODEL_FLAGS $DIFFUSION_FLAGS
    echo "===================================================================================" 
done;
