...
DIR_TRAIN="--data_dir /lustre/ssd/ws/dchristi-diffusion2/dataset/fiber-data_256x256 --dir /home/s5409693/checkpoints/fiber_1x256x256_test_w_d"


python scripts/image_train_descriptor.py $DIR_TRAIN $MODEL_FLAGS $CHECK_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS
