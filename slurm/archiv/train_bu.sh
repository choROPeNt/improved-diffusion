...
TRAIN_FLAGS="--lr 1e-4 --batch_size 4 --lr_anneal_steps=300000"
DIR_TRAIN="--data_dir /lustre/ssd/ws/dchristi-diffusion2/dataset/fiber-data_256x256 --dir /lustre/ssd/ws/dchristi-diffusion2/checkpoints/fiber_1x256x256_cond3_1k_test"
