...
#SBATCH --gres=gpu:1
#SBATCH --job-name=torch_descr_diff
#SBATCH --output=slurm_out/diffusion_train-%j.out    # after the shebang line
...
DIR_TRAIN="--data_dir datasets/fiber-data_256x256 --dir checkpoints/fiber_1x256x256_test_w_d"


python scripts/image_train_descriptor_th.py $DIR_TRAIN $MODEL_FLAGS $CHECK_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS
